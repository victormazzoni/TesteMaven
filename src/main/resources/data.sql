DELETE FROM QUESTAO;
INSERT INTO QUESTAO(NOME, OBRIGATORIO) VALUES ('Como você avaliaria sua expectativa em relação ao curso? *' ,TRUE);
INSERT INTO QUESTAO(NOME, OBRIGATORIO) VALUES ('Como você avaliaria a realização do curso? *' ,TRUE);
INSERT INTO QUESTAO(NOME, OBRIGATORIO) VALUES ('Que nota você daria para o instrutor desse treinamento? *' ,TRUE);
INSERT INTO QUESTAO(NOME, OBRIGATORIO) VALUES ('O conteúdo foi adequado e é aplicável no seu dia-a-dia? *' ,TRUE);
